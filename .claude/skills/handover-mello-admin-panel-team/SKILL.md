---
description: Handover tasks at 80% context for the Admin Panel Team
user-invocable: true
---
...
- YOU MUST update following:
  ...
  - .claude/agent_docs/progress-mello-admin-panel-team-dev.md
  ...
  - .claude/skills/resume-context-mello-admin-panel-team/context.md
   ...
   (ask USER to resolve significant conflicts via web gui)
